...
- Supabase RLS policies must cover every table — never rely solely on app-level checks.
- Edge Function secrets live in Supabase dashboard only — never in repo files.
