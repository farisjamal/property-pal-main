        ...
        <div className="flex items-center justify-between p-6 border-b border-border">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <span className="block text-[10px] font-medium uppercase tracking-widest text-muted-foreground">Owner Portal</span>
            </div>
          </div>
        ...
        <div className="p-5 border-t border-border bg-card/60 mt-auto">
           <div className="flex items-center gap-3 mb-5 px-1">
              ...
              <div className="flex-1 overflow-hidden">
                <p className="text-sm font-medium truncate text-foreground">{userProfile?.name || 'Owner'}</p>
          ...
          <div className="bg-card/80 backdrop-blur-xl border border-border shadow-sm rounded-xl p-3 sm:p-4 flex items-center justify-between">
            ...
            <div className="flex items-center gap-2">
              ...
              <div className="hidden sm:flex items-center gap-2 px-3 py-1.5 rounded-md bg-secondary/40 border border-border">
                ...
                <span className="text-[11px] font-medium tracking-widest text-muted-foreground uppercase">Owner Edition</span>
              </div>
            </div>
          </div>
        </header>
